...
class OpcionesPVP extends JFrame {
    ...
    private void prepareTamanoPanel() {
        ...
        JPanel modoPorcentajes = new JPanel(new BorderLayout());
        panelTamano.add(modoPorcentajes, BorderLayout.EAST);

        // Crear el panel porcentajes con GridLayout
        ...
        modoPorcentajes.add(porcentajes, BorderLayout.WEST);
        ...
        modoPorcentajes.add(panelModoJuego, BorderLayout.EAST);
        ...
        botonJugar.addActionListener(e -> {
            ...
            if(modo.equals("Normal") || modo.equals("Quicktime")) {
                ...
                if (textoCasilla.isEmpty() || textoFicha.isEmpty()) {
                    JOptionPane.showMessageDialog(OpcionesPVP.this, "Por favor, Ingrese los porcentajes tanto para Casillas como Fichas.",
                            "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
